...
export const CommonModal = ({
  ...
  return (
    <div className={`fixed z-50 flex items-center justify-center w-[calc(100vw+3px)] h-[calc(100vh+3px)] overflow-hidden -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 bg-bg-dark bg-opacity-70 backdrop-blur ${!show && 'hidden'}`}>
