...
export const CommonModal = ({
  ...
  return (
    <div className={`fixed z-50 flex items-center justify-center w-screen h-screen overflow-hidden -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 bg-bg-dark bg-opacity-70 backdrop-blur ${!show && 'hidden'}`}>
